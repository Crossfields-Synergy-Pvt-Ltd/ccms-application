...
public class DCUConfiguration {
	...
	public String getDcu_identifier() {
		return dcu_identifier;
	}

	public void setDcu_identifier(String dcu_identifier) {
		this.dcu_identifier = dcu_identifier;
	}
	...
	public String toString() {
		return "DCUConfiguration [dcu_id=" + dcu_id + ", dcu_identifier="
				+ dcu_identifier + ", overwrite_flash=" + overwrite_flash
				+ ", retry_count=" + retry_count + ", retry_interval="
				+ retry_interval + ", apn_name=" + apn_name
				+ ", apn_user_name=" + apn_user_name + ", apn_password="
				+ apn_password + ", frequency_band=" + frequency_band
				+ ", meter_polling_interval=" + meter_polling_interval
				+ ", Primary_server_ip=" + Primary_server_ip
				+ ", primary_server_port=" + primary_server_port
				+ ", primary_dns=" + primary_dns + ", secondary_server_ip="
				+ secondary_server_ip + ", secondary_server_port="
				+ secondary_server_port + ", secondary_dns=" + secondary_dns
				+ ", pan_id=" + pan_id + ", rf_frequency=" + rf_frequency
				+ ", tx_power=" + tx_power + ", rf_idle_timeout="
				+ rf_idle_timeout + ", rf_retry_count=" + rf_retry_count
				+ ", mod_value=" + mod_value + ", stop_bit_1=" + stop_bit_1
				+ ", baud_rate_1=" + baud_rate_1 + ", Parity_1=" + Parity_1
				+ ", data_bits_1=" + data_bits_1 + ", serial_retry_count_1="
				+ serial_retry_count_1 + ", serial_retry_interval_1="
				+ serial_retry_interval_1 + ", stop_bits_2=" + stop_bits_2
				+ ", baud_rate_2=" + baud_rate_2 + ", parity_2=" + parity_2
				+ ", data_bits_2=" + data_bits_2 + ", serial_retry_count_2="
				...
				+ number_5 + ", file_identifier=" + file_identifier
				+ ", status=" + status + ", serial_retry_interval_2="
				+ serial_retry_interval_2 + ", retry_intravl_for_io_recovery="
				+ retry_intravl_for_io_recovery + ", hop_count=" + hop_count
