...
public class Meter {
	...
	public String getCurrent_md() {
		return current_md;
	}

	public void setCurrent_md(String current_md) {
		this.current_md = current_md;
	}
	...
	public String getPrev_md() {
		return prev_md;
	}

	public void setPrev_md(String prev_md) {
		this.prev_md = prev_md;
	}
	...
	public String toString() {
		return "MeterData [id=" + id + ", slave_id=" + slave_id
				...
				+ ", current_md=" + current_md + ", current_date="
				+ current_date + ", prev_md=" + prev_md + ", prev_date="
				+ prev_date + "]";
	}
