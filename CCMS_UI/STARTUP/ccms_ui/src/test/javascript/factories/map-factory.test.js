describe('mapFactory', function() {
    ...
    describe('getAllCount', function() {
        it('should call /dashboard/count with query params', function() {
        ...
        it('should handle empty response', function() {
            $httpBackend.whenGET('/dashboard/count?x=y')
                .respond({});
    ...
    describe('getAllMapDashboardData', function() {
        it('should call /dashboard/map_data with query params', function() {
