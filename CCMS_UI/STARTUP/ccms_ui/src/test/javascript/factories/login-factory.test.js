describe('loginFactory', function() {
    ...
    describe('login_user', function() {
        it('should call the correct URL with query params', function() {
            $httpBackend.expectGET('/superadmin/user/login?name=test@test.com&password=pass123')
                .respond({ status: '100' });
        ...
        it('should return user data on success', function() {
            ...
            $httpBackend.whenGET('/superadmin/user/login?name=test@test.com&password=pass123')
        ...
        it('should handle empty query string', function() {
            $httpBackend.expectGET('/superadmin/user/login')
                .respond({ status: '00' });
        ...
        it('should handle server error gracefully', function() {
            $httpBackend.whenGET('/superadmin/user/login?name=error')
