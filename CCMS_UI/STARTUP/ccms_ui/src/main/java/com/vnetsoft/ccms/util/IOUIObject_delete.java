...
public class IOUIObject_delete {
	...
	private int cumulative_on_hour;
	...
	private int cumulative_off_hour;
	...
	public int getCumulative_on_hour() {
		return cumulative_on_hour;
	}

	public void setCumulative_on_hour(int cumulative_on_hour) {
	...
	public int getCumulative_off_hour() {
		return cumulative_off_hour;
	}

	public void setCumulative_off_hour(int cumulative_off_hour) {
		this.cumulative_off_hour = cumulative_off_hour;
	}

	@Override
	public String toString() {
		return "IOUIObject [date=" + date + ", on_hour_min=" + on_hour_min
				+ ", on_status=" + on_status + ", cumulative_on_hour="
				+ cumulative_on_hour + ", off_hour_min=" + off_hour_min
				+ ", off_status=" + off_status + ", cumulative_off_hour="
				+ cumulative_off_hour + "]";
	}
